<?php
    ...
    class UserActionDisplay {
		...
		public function generate_ciloadurl(UserAction $action) {
			...
			return $urlconfig->get_ciURL($action->customerlink, $action->shiptolink);
		}
		...
		public function generate_customerURL(UserAction $action) {
			$urlconfig = DplusoConfigURLs::get_instance();
			return $urlconfig->get_ciURL($action->customerlink);
		}
		...
		public function generate_contacturl(UserAction $action) {
			$urlconfig = DplusoConfigURLs::get_instance();
			return $urlconfig->get_customer_contactURL($action->customerlink, $action->shiptolink, $action->contactlink);
		}
